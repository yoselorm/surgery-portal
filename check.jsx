...
const BiolitecLaserLHPForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log('New Surgery Record:', newRecord);
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-8 text-white">
                        ...
                        <p className="text-cyan-100">Data Collection Form</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-8">
                    ...
                    {/* Section 5: Additional Differential Diagnostics */}
                    <div className="pt-6 border-t border-gray-200">
                        <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center space-x-2">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                        <h2 className="text-xl font-bold text-gray-900 mb-6">Treatment Methods</h2>
                    ...
                    {/* Section 7: Anaesthesia & Complications */}
                    <div className="pt-6 border-t border-gray-200">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                        ...
                        {formData.intraOperativeData.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                ...
                                {formData.intraOperativeData.length > 0 && (
                                    <div className="mt-6 p-4 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-lg border-2 border-cyan-200">
                                        <div className="flex items-center justify-between">
                                            <span className="text-lg font-bold text-gray-900">Total Energy Applied:</span>
                                            <span className="text-2xl font-bold text-cyan-600">{calculateTotalEnergy().toFixed(2)} J</span>
                                        </div>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="pt-6 border-t border-gray-200">
                        <h2 className="text-xl font-bold text-gray-900 mb-6">Postoperative Medication</h2>
                        <div>
                            <textarea
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                                rows="3"
                                placeholder="Enter postoperative medication details"
                            />
                        </div>
                    </div>
                    ...
                    {/* Action Buttons */}
                    <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row gap-4 justify-between">
                        <button
                            type="button"
                            onClick={handleSaveDraft}
                            className="flex items-center justify-center space-x-2 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition font-semibold"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-lg hover:shadow-lg transition font-semibold"
                        >
